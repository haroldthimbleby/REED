...
"\n"
"    ### NB if an id is not defined as a non-terminal, it is a literal: e.g., black\n\n"
...
"\n"
"    arrow ::= influences: | -> | <- \n"
"    color ::= aqua | black | blue | fuchsia | gray | grey\n"
...
"    id-or-star ::= id | *\n"
"    keywordlist ::= { keyword | keywords } node-list\n"
"    node-list ::= id | ( id++ )\n"
...
"    document-property id!Specify document properties. Details append when given multiple times!(See also <definitions> for more properties)\n"
...
"    [ keywordlist ] note node-or-arrow-list [ properties ] [ is id1 [;] ] id3!Provide narrative note <id3> for the nodes or arrows, optionally naming them <id1>\n"
"    numbering ( { ( id-or-star++ ) }++ )!Make node references row.column numbers following the grid layout\n"
"    property node-or-arrow-list [ properties ]!associate property list with nodes and arrows\n"
...
"!<author>, <definitions.html>, <definitions.latex>, <definitions.latexend>!which all concatenate in the order given,"
