...
"    conclusion id!Define the Latex or HTML document conclusion\n"
...
"    introduction id!Define the Latex or HTML document introduction\n"
...
"    layout [ TOC ] ( { id ( id+ ) }++ )!Draw a graph with a structured layout, with optional TOC (Theory of Change) styling (more stylings to come)\n"
