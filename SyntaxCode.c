...
"    [ keywords node-or-arrow-list ] note node-or-arrow-list [ is id1 [;] ] [ author id2 [;] ] id3!Optionally name nodes or arrows id1, and provide narrative note id3 for them, optionally with one or more keywords/keyphrases\n"
