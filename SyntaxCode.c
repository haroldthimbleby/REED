...
"    style node-or-arrow-list is: id!Set style of nodes or arrows, either to a named style!or to an explicit Dot specification which can contain further REED style names\n"
"    style.cycle id!Define style to highlight cycles\n"
"    style.default id!Define default style for nodes and edges\n"
"    style.new id1 is id2!Define <id1> as a style, using Dot syntax for <id2>!<id2> can contain REED style names\n"
...
"\n"
"    ;!semicolons are empty statements!can be placed freely between statements and in <note> statements to aid legibility\n"
"\n"
"!The order of commands generally does not matter"
"!Except: !<author>, <htmldefinitions>, <latexFinal>, <latexdefinitions> which concatenate"
