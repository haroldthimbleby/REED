...
document-details ::=  abstract | author | date | email | feedback | introduction | conclusion | latexdefinitions | htmldefinitions | title 
...
document-details id!Specify document details. Details append when repeated!(e.g., for multiple authors)
