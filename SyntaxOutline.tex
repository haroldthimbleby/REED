...
invisible id|make <id> invisible (can be reset to visible with visible command)
...
visible id|Make <id> visible (can be reset to invisible with invisible command)
