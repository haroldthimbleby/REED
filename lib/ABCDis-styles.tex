...
\multicolumn{5}{@{}|l|}{Single version}\\
 8 & nodes & --- & 0 & highlighted\\&&& 0 & with notes\\

    7 & arrows & --- & 0 & with notes\\\hline
\end{tabular}
\vskip 4mm
\noindent
\begin{tabular}{|ll|}\hline 
REED files&Digital signatures\\ \hline 
lib/ABCDis-styles & 5f63b85a082d0bc968b8a22d59cd01ae \\
lib/ABCD & 6dce412672c091705dcefd5e912be3dc \\
lib/TB & e84f75cdb35f8a96a0b3b68acf4d8f44 \\
\hline
\end{tabular}
...
\textbf{Node  Internal interference? }\\\textbf{Node  Signed off by IT       }\\\textbf{Node  Sources of data        }\\\textbf{Node  Undetected cyberattack }\\\textbf{Node 1 A}\\\textbf{Node 2 B}\\\textbf{Node 3 C}\\\textbf{Node 4 The IT department} [D]\\
