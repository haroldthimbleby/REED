...
\colorflag{blue}&Cascaded node&v3-3.0&\hyperlink{Abbott_engineer}{Unsupervised Abbott engineer}\\
\colorflag{blue}&&v2-4.2&\hyperlink{7}{Abbott PrecisionWeb database}\\
\colorflag{blue}&\scriptsize (white before cascade)&v2-4.3&\hyperlink{6}{Ward PCs}\\
\colorflag{blue}&\scriptsize (red before cascade)&v2-5.1&\hyperlink{11}{Police forensic database system}\\
\colorflag{blue}&\scriptsize (white before cascade)&v2-5.2&\hyperlink{backups}{No known backups that could have  provided evidence}\\
\colorflag{blue}&\scriptsize (red before cascade)&v2-5.3&\hyperlink{10}{Frequent crashes documented}\\
\colorflag{blue}&\scriptsize (yellow before cascade)&v2-5.4&\hyperlink{8}{Lots of unknown complex middleware}\\
\colorflag{blue}&\scriptsize (red before cascade)&v2-6.1&\hyperlink{12}{Main Police evidence}\\
\colorflag{blue}&\scriptsize (yellow before cascade)&v2-6.2&\hyperlink{9}{Main hospital databases}\\
\colorflag{blue}&\scriptsize (white before cascade)&v2-8.1&\hyperlink{3}{Nurse-written paper records (never disclosed)}\\
...
\colorflag{white}&&v2-1.4&\hyperlink{13}{Hospital computer operators}\\
\colorflag{white}&&v2-2.2&\hyperlink{4}{XceedPros on Ward 2}\\
\colorflag{white}&&v2-3.3&\hyperlink{5}{XceedPro dock on ward}\\
\colorflag{yellow}&&v2-3.4&\hyperlink{14}{No evidence of any testing ever performed}\\
\colorflag{yellow}&&v2-4.4&\hyperlink{15}{No evidence of error logs or audits}\\
\colorflag{yellow}&&v2-4.5&\hyperlink{forensicProblems}{No evidence to support reliability of forensic methods}\\
...
\hypertarget{Abbott_engineer}{\subsection*{ \colorflag{blue} Node v3-3.0 Unsupervised Abbott engineer}}
...
\vskip .5ex\vbox{\small \hskip 2em\\$\rightarrow$ \hyperlink{7}{\colorflag{blue}~v2-4.2 Abbott PrecisionWeb database}}

\hypertarget{1}{\subsection*{Node v2-1.2 Defendant nurses on Ward 2}}
	The defendants were named, and provided witness statements.
\vskip .5ex\vbox{\small \hskip 2em\\$\rightarrow$ \hyperlink{6}{\colorflag{blue}~v2-4.3 Ward PCs}\hskip 2em\\$\rightarrow$ \hyperlink{4}{\colorflag{white}~v2-2.2 XceedPros on Ward 2}\hskip 2em\\$\rightarrow$ \hyperlink{3}{\colorflag{blue}~v2-8.1 Nurse-written paper records (never disclosed)}}
...
\hypertarget{13}{\subsection*{ \colorflag{white} Node v2-1.4 Hospital computer operators}}
	...
	Note how (using Statechart conventions for diagrams) a \emph{single\/} arrow from node \hyperlink{13}{{v2--1.4}, ``Hospital computer operators''}) to the group \hyperlink{hospital}{{v2--7.1}, ``Hospital IT Systems''} is sufficient to show that computer operators affect \emph{all\/} nodes inside the box.\footnote{Statecharts, invented by David Harel, are well-known diagrams widely used in computer science.}
\vskip .5ex\vbox{\small \hskip 2em\\$\rightarrow$ \hyperlink{hospital}{\hphantom{\colorflag{white}}~v2-7.1 Hospital IT Systems}\hskip 2em\\$\rightarrow$ \hyperlink{14}{\colorflag{yellow}~v2-3.4 No evidence of any testing ever performed}}
...
\hypertarget{14}{\subsection*{ \colorflag{yellow} Node v2-3.4 No evidence of any testing ever performed}}
	\warn{The hospital presented no evidence that it knew that any of its systems were reliable. However, the hospital did present evidence that PrecisionWeb regularly crashes (node \hyperlink{10}{{v2--5.3}, ``Frequent crashes documented''}).}
\vskip .5ex\vbox{\small \hskip 2em\\$\rightarrow$ \hyperlink{15}{\colorflag{yellow}~v2-4.4 No evidence of error logs or audits}}

\hypertarget{7}{\subsection*{ \colorflag{blue} Node v2-4.2 Abbott PrecisionWeb database\\\hskip 2em --- (Group: Hospital IT Systems) }}
	PrecisionWeb is a proprietary database designed to monitor XceedPros, such as their battery health. 
	
	PrecisionWeb manual warns that it is not designed for clinical use, but the Princess of Wales hospital used it clinically --- the blood glucose readings (amongst other data) are copied, via middleware (node \hyperlink{8}{{v2--5.4}, ``Lots of unknown complex middleware''}) to the main hospital database. \warn{It is therefore not clear that PrecisionWeb is reliable enough to present patient data as evidence.}
\vskip .5ex\vbox{\small \hskip 2em\\$\rightarrow$ \hyperlink{backups}{\colorflag{blue}~v2-5.2 No known backups that could have  provided evidence}\hskip 2em\\$\rightarrow$ \hyperlink{8}{\colorflag{blue}~v2-5.4 Lots of unknown complex middleware}\hskip 2em\\$\rightarrow$ \hyperlink{11}{\colorflag{blue}~v2-5.1 Police forensic database system}\hskip 2em\\$\rightarrow$ \hyperlink{10}{\colorflag{blue}~v2-5.3 Frequent crashes documented}}

\hypertarget{6}{\subsection*{ \colorflag{blue} Node v2-4.3 Ward PCs\\\hskip 2em --- (Group: Hospital IT Systems) }}
...
\vskip .5ex\vbox{\small \hskip 2em\\$\rightarrow$ \hyperlink{8}{\colorflag{blue}~v2-5.4 Lots of unknown complex middleware}}

\hypertarget{15}{\subsection*{ \colorflag{yellow} Node v2-4.4 No evidence of error logs or audits}}
...
\hypertarget{forensicProblems}{\subsection*{ \colorflag{yellow} Node v2-4.5 No evidence to support reliability of forensic methods}}
...
\vskip .5ex\vbox{\small \hskip 2em\\$\rightarrow$ \hyperlink{11}{\colorflag{blue}~v2-5.1 Police forensic database system}}

\hypertarget{11}{\subsection*{ \colorflag{blue} Node v2-5.1 Police forensic database system}}
...
\vskip .5ex\vbox{\small \hskip 2em\\$\rightarrow$ \hyperlink{12}{\colorflag{blue}~v2-6.1 Main Police evidence}}

\hypertarget{backups}{\subsection*{ \colorflag{blue} Node v2-5.2 No known backups that could have  provided evidence}}
...
\vskip .5ex\vbox{\small \hskip 2em\\$\rightarrow$ \hyperlink{9}{\colorflag{blue}~v2-6.2 Main hospital databases}}

\hypertarget{10}{\subsection*{ \colorflag{blue} Node v2-5.3 Frequent crashes documented}}
...
\hypertarget{8}{\subsection*{ \colorflag{blue} Node v2-5.4 Lots of unknown complex middleware\\\hskip 2em --- (Group: Hospital IT Systems) }}
	PrecisionWeb (node \hyperlink{7}{{v2--4.2}, ``Abbott PrecisionWeb database''}) is not interoperable with other hospital systems, so middleware Conworx is used to interface PrecisionWeb to the main patient databases.
...
\hypertarget{12}{\subsection*{ \colorflag{blue} Node v2-6.1 Main Police evidence}}
...
Refer to node \hyperlink{11}{{v2--5.1}, ``Police forensic database system''}. 


\hypertarget{9}{\subsection*{ \colorflag{blue} Node v2-6.2 Main hospital databases\\\hskip 2em --- (Group: Hospital IT Systems) }}
...
\vskip .5ex\vbox{\small \hskip 2em\\$\rightarrow$ \hyperlink{3}{\colorflag{blue}~v2-8.1 Nurse-written paper records (never disclosed)}}

\hypertarget{hospital}{\subsection*{Node v2-7.1 Hospital IT Systems}}
...
\vskip .5ex\vbox{\small \hskip 2em\\$\rightarrow$ \hyperlink{14}{\colorflag{yellow}~v2-3.4 No evidence of any testing ever performed}}

\hypertarget{3}{\subsection*{ \colorflag{blue} Node v2-8.1 Nurse-written paper records (never disclosed)}}
...
\subsection*{Arrow ?\\
\setbox0=\hbox{$\rightarrow$~}\hbox to \wd0{}v2-4.2 \hyperlink{7}{Abbott PrecisionWeb database}\\\copy0{}v2-5.4 \hyperlink{8}{Lots of unknown complex middleware}}
Arrows marked ``\textbf{?}'' indicate evidence flows that we \emph{should\/} know about, but no relevant information has been made available, despite requests. We think the evidence probably does not exist because (we surmise that) the IT operators probably did not do the appropriate work, such as testing (see \hyperlink{14}{{v2--3.4}, ``No evidence of any testing ever performed''}).
\subsection*{Arrow  A\\
...
\subsection*{Arrow  D\\
\setbox0=\hbox{$\rightarrow$~}\hbox to \wd0{}v2-3.3 \hyperlink{5}{XceedPro dock on ward}\\\copy0{}v2-4.2 \hyperlink{7}{Abbott PrecisionWeb database}}
...
\subsection*{Arrow  E\\
\setbox0=\hbox{$\rightarrow$~}\hbox to \wd0{}v2-4.2 \hyperlink{7}{Abbott PrecisionWeb database}\\\copy0{}v2-5.1 \hyperlink{11}{Police forensic database system}}
...
\subsection*{Arrow   F\\
\setbox0=\hbox{$\rightarrow$~}\hbox to \wd0{}v2-5.1 \hyperlink{11}{Police forensic database system}\\\copy0{}v2-6.1 \hyperlink{12}{Main Police evidence}}
